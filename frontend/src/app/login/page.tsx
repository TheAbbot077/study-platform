...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#0f0b1c] px-6 py-16 text-[#fbf7ee]">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(48,35,82,0.28),_transparent_26%),radial-gradient(circle_at_bottom_right,_rgba(202,160,79,0.18),_transparent_28%),radial-gradient(circle_at_top_right,_rgba(62,44,116,0.26),_transparent_30%)]" />
      ...
      <div className="relative mx-auto grid min-h-[calc(100vh-8rem)] max-w-6xl items-center gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(380px,0.85fr)]">
        <section className="max-w-2xl">
          ...
          <h1 className="mt-7 text-5xl font-semibold leading-tight tracking-tight text-[#fbf7ee]">
            Return to your library of subjects and continue where you left off.
          </h1>

          <p className="mt-6 max-w-xl text-lg leading-8 text-[#cec5e1]">
            Sign in to open your dashboard, view your subject progress, and step
            back into the tutor with your study history still intact.
          </p>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-2">
            <div className="rounded-3xl border border-[#d0a95b]/18 bg-[linear-gradient(180deg,_rgba(34,25,58,0.92)_0%,_rgba(22,17,36,0.96)_100%)] p-5 shadow-sm backdrop-blur-sm">
              ...
              <p className="mt-3 text-sm leading-6 text-[#d6cde8]">
                Dashboard to progress page to tutor, all in one steady learning path.
              </p>
            </div>
            ...
            <div className="rounded-3xl border border-[#d0a95b]/18 bg-[linear-gradient(180deg,_rgba(34,25,58,0.92)_0%,_rgba(22,17,36,0.96)_100%)] p-5 shadow-sm backdrop-blur-sm">
              ...
              <p className="mt-3 text-sm leading-6 text-[#d6cde8]">
                Your concept history, checkpoints, and mastery trail are ready when you are.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="rounded-[2rem] border border-[#d0a95b]/18 bg-[#19142d]/92 p-8 shadow-[0_25px_80px_rgba(0,0,0,0.28)] backdrop-blur-sm sm:p-10">
          <div className="rounded-[1.5rem] border border-white/10 bg-[linear-gradient(180deg,_rgba(29,22,53,0.95)_0%,_rgba(19,14,34,0.98)_100%)] p-6 sm:p-8">
            <h2 className="text-3xl font-bold text-[#fbf7ee]">Login</h2>
            ...
            <p className="mt-6 text-sm text-[#c5bbd9]">
              Need an account?{" "}
              <Link href="/signup" className="font-semibold text-[#ddb86c] underline">
                Create one
              </Link>
            </p>
          </div>
